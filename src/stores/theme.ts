...
function persistValue(key: string, value: string): void {
  ...
  try {
    ...
    // Safari "Block all cookies" throws SecurityError; keep in-memory state only.
  }
}
...
if (typeof window !== 'undefined') {
  try {
    ...
    // Safari "Block all cookies" throws SecurityError; fall back to defaults.
  }
